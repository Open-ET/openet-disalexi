...
+ `Computing daily ET for a single Landsat TOA image <examples/landsat_c1_toa_image.ipynb>`__
+ `Computing daily ET for a single Landsat SR image <examples/landsat_c1_sr_image.ipynb>`__
