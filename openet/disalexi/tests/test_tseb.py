...
@pytest.mark.parametrize(
    ...
    [
        ...
        [296.86259968439742, 302.49074951171878, 7.02662301063538,
         ...
         0.44531310527793, 17 + 5.0 / 60,
         0.5 * (11.02448526443880 + 26.01087501850882), 0.05, 1.32, 36, 10,
         5.80784207568089 / 0.408],
...
def test_tseb_pt(T_air, T_rad, u, p, z, Rs_1, Rs24, vza, zs, aleafv, aleafn,
    ...
    output_image = tseb.tseb_pt(
        ...
        ee.Image.constant(time), ee.Image.constant(t_noon),
        ee.Image.constant(leaf_width), ee.Image.constant(a_PT_in),
        stabil_iter, albedo_iter)
