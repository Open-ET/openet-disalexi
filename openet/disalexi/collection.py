...
class Collection:
    ...
    def __init__(
        ...
        self.landsat_c02_l2_collections = [
        ...
        for coll_id in self.collections:
            if coll_id not in self.landsat_c02_l2_collections:
    ...
    def _build(self, variables=None, start_date=None, end_date=None):
        ...
        for coll_id in self.collections:
            if coll_id in self.landsat_c02_l2_collections:
                input_coll = (
                ...
                def compute_vars(image):
                    model_obj = Image.from_landsat_c02_l2(sr_image=ee.Image(image), **self.model_args)
    ...
    def interpolate(
        ...
        interp_properties = {
            ...
            'interp_days': interp_days,
            'interp_method': interp_method,
            'model_name': metadata.metadata('openet-disalexi')['Name'],
            'model_version': metadata.metadata('openet-disalexi')['Version'],
        }
